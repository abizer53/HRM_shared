    ...
    <div class="scrollbar-inner">
            ...
            <ul class="navbar-nav navbar-nav-docs">
                ...
                @else
                    @if (Gate::check('Manage User') ||
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::route()->getName() == 'user.index' || Request::route()->getName() == 'roles.index' || Request::route()->getName() == 'permissions.index' || Request::route()->getName() == 'employee.profile' || Request::route()->getName() == 'lastlogin' ? 'active' : 'collapsed' }}"
                                href="#navbar-staff" data-toggle="collapse" role="button"
                                aria-expanded="{{ Request::route()->getName() == 'user.index' ||
                            ...
                            <div class="collapse {{ Request::route()->getName() == 'user.index' || Request::route()->getName() == 'roles.index' || Request::route()->getName() == 'permissions.index' || Request::route()->getName() == 'employee.profile' || Request::route()->getName() == 'lastlogin' ? 'show' : '' }}"
                                id="navbar-staff">
                                    ...
                                    @can('Manage Employee Profile')
                                        <li class="nav-item {{ request()->is('employee-profile') ? 'active' : '' }}">
                                            <a href="{{ route('employee.profile') }}"
                                                class="nav-link">{{ __('Employee Profile') }}</a>
                                        </li>
                                    @endcan
                    ...
                    @else
                        <li class="nav-item">
                            <a href="{{ route('employee.index') }}"
                                class="nav-link  {{ Request::route()->getName() == 'employee.index' || Request::route()->getName() == 'employee.create' || Request::route()->getName() == 'employee.edit' || Request::route()->getName() == 'employee.show' ? 'active' : '' }}">
                                <i class="fas fa-users"></i>{{ __('Employee') }}
                            </a>
                        </li>
                    @endif
                ...
                @if (Gate::check('Manage Set Salary') || Gate::check('Manage Pay Slip'))
                    <li class="nav-item">
                        <a class="nav-link {{ Request::route()->getName() == 'setsalary.index' || Request::route()->getName() == 'setsalary.show' || Request::route()->getName() == 'payslip.index' || Request::route()->getName() == 'payslipupload.index' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'setsalary.edit' || Request::route()->getName() == 'employeesalary' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'payslip.pdf' ? 'active' : 'collapsed' }}"
                            ...
                            aria-expanded="{{ Request::route()->getName() == 'setsalary.index' ||
                        ...
                        <div class="collapse {{ Request::route()->getName() == 'setsalary.index' || Request::route()->getName() == 'setsalary.show' || Request::route()->getName() == 'payslip.index' || Request::route()->getName() == 'payslipupload.index' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'setsalary.edit' || Request::route()->getName() == 'employeesalary' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'payslip.pdf' ? 'show' : '' }}"
                            ...
                            <ul class="nav flex-column submenu-ul">
                                ...
                                -->
                                <li class="nav-item {{ request()->is('payslipupload*') ? 'active' : '' }}">
                                    <a href="{{ route('payslipupload.index') }}"
                                        class="nav-link">{{ __('Payslip Upload') }}</a>
                                </li>
                ...
                @if (Gate::check('Manage Attendance') || Gate::check('Manage Leave') || Gate::check('Manage TimeSheet'))
                    <li class="nav-item">
                        <a class="nav-link {{ Request::route()->getName() == 'attendanceemployee.index' || Request::route()->getName() == 'leave.index' || Request::route()->getName() == 'timesheet.index' || Request::route()->getName() == 'attendanceemployee.bulkattendance' ? 'active' : 'collapsed' }}"
                            ...
                            aria-expanded="{{ Request::route()->getName() == 'attendanceemployee.index' || Request::route()->getName() == 'leave.index' || Request::route()->getName() == 'timesheet.index' || Request::route()->getName() == 'attendanceemployee.bulkattendance' ? 'true' : 'false' }}"
                            aria-controls="navbar-timesheet">
                            <i class="fas fa-clock"></i>{{ __('Attendance') }}
                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse {{ Request::route()->getName() == 'attendanceemployee.index' || Request::route()->getName() == 'leave.index' || Request::route()->getName() == 'timesheet.index' || Request::route()->getName() == 'attendanceemployee.bulkattendance' ? 'show' : '' }}"
                            id="navbar-timesheet">
                            <ul class="nav flex-column submenu-ul">
                                ...
                                @can('Manage Attendance')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'attendanceemployee.index' ? 'active' : '' }}">
                                ...
                                @can('Create Attendance')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'attendanceemployee.bulkattendance' ? 'active' : '' }}">
                ...
                @if (Gate::check('Manage Indicator') || Gate::check('Manage Appraisal') || Gate::check('Manage Goal Tracking'))
                    <li class="nav-item">
                        <a class="nav-link {{ Request::route()->getName() == 'indicator.index' || Request::route()->getName() == 'appraisal.index' || Request::route()->getName() == 'goaltracking.index' ? 'active' : 'collapsed' }}"
                            href="#navbar-performance" data-toggle="collapse" role="button"
                            aria-expanded="{{ Request::route()->getName() == 'indicator.index' || Request::route()->getName() == 'appraisal.index' || Request::route()->getName() == 'goaltracking.index' ? 'true' : 'false' }}"
                            aria-controls="navbar-performance">
                            <i class="fas fa-cube"></i>{{ __('Performance') }}
                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse {{ Request::route()->getName() == 'indicator.index' || Request::route()->getName() == 'appraisal.index' || Request::route()->getName() == 'goaltracking.index' ? 'show' : '' }}"
                ...
                @if (Gate::check('Manage Awards') ||
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::route()->getName() == 'award.index' ||
                        ...
                        Request::route()->getName() == 'announcement.index'
                            ...
                            aria-expanded="{{ Request::route()->getName() == 'award.index' ||
                            Request::route()->getName() == 'transfer.index' ||
                            Request::route()->getName() == 'resignation.index' ||
                            Request::route()->getName() == 'travel.index' ||
                            Request::route()->getName() == 'promotion.index' ||
                        ...
                        <div class="collapse {{ Request::route()->getName() == 'award.index' ||
                        Request::route()->getName() == 'transfer.index' ||
                        Request::route()->getName() == 'resignation.index' ||
                        Request::route()->getName() == 'travel.index' ||
                        Request::route()->getName() == 'promotion.index' ||
                ...
                @if (Gate::check('Manage Job') ||
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::route()->getName() == 'job.index' ||
                        ...
                        Request::route()->getName() == 'interview-schedule.index'
                           ...
                           aria-expanded="{{ Request::route()->getName() == 'job.index' ||
                           Request::route()->getName() == 'job.create' ||
                           Request::route()->getName() == 'job.edit' ||
                           Request::route()->getName() == 'job.show' ||
                           Request::route()->getName() == 'job-application.index' ||
                        ...
                        <div class="collapse {{ Request::route()->getName() == 'job.index' ||
                        Request::route()->getName() == 'job.create' ||
                        Request::route()->getName() == 'job.edit' ||
                        Request::route()->getName() == 'job.show' ||
                        Request::route()->getName() == 'job-application.index' ||
                ...
                @if (Gate::check('Manage Ticket') || Gate::check('Manage Meeting'))
                    <li class="nav-item">
                        <a class="nav-link {{ Request::route()->getName() == 'chats' ||
                        request()->is('ticket*') ||
                        request()->is('meeting*') ||
                        Request::segment(1) == 'zoom-meeting'
                            ...
                            aria-expanded="{{ Request::route()->getName() == 'chats' ||
                            request()->is('ticket*') ||
                            request()->is('meeting*') ||
                            Request::segment(1) == 'zoom-meeting'
                                ? 'true'
                            ...
                            <i class="fas fa-comments"></i>{{ __('Social') }}
                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse {{ Request::route()->getName() == 'chats' ||
                        request()->is('ticket*') ||
                        request()->is('meeting*') ||
                        Request::segment(1) == 'zoom-meeting'
                            ? 'show'
                            ...
                            <ul class="nav flex-column submenu-ul">
                                ...
                                @if (\Auth::user()->type != 'super admin')
                                    <li
                                        class="nav-item {{ Request::route()->getName() == 'chats' ? 'active' : '' }}">
                                        <a href="{{ url('chats') }}" class="nav-link">{{ __('Messenger') }}</a>
                                    </li>
                                @endif

                                @can('Manage Ticket')
                                    <li class="nav-item {{ request()->is('ticket*') ? 'active' : '' }}">
                                        <a href="{{ route('ticket.index') }}" class="nav-link">{{ __('Ticket') }}</a>
                                    </li>
                                @endcan
                                ...
                                <li class="nav-item {{ Request::segment(1) == 'zoom-meeting' ? 'active' : '' }}">
                                    <a href="{{ route('zoom-meeting.index') }}"
                                        class="nav-link">{{ __('Zoom Meeting') }}</a>
                                </li>
                ...
                @if (Gate::check('Manage Assets'))
                    <li class="nav-item">
                        <a href="{{ route('account-assets.index') }}"
                            class="nav-link {{ Request::segment(1) == 'account-assets' ? 'active' : '' }}">
                ...
                @if (Gate::check('Manage Document'))
                    <li class="nav-item">
                        <a href="{{ route('document-upload.index') }}"
                            class="nav-link {{ Request::segment(1) == 'document-upload' ? 'active' : '' }}">
                ...
                @if (Gate::check('Manage Company Policy'))
                    <li class="nav-item">
                        <a href="{{ route('company-policy.index') }}"
                            class="nav-link {{ Request::segment(1) == 'company-policy' ? 'active' : '' }}">
                ...
                -->
                                    <li
                                        class="nav-item {{ request()->is('report/monthly/attendance') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('report.monthly.attendance') }}">{{ __('Monthly Attendance') }}</a>
                                    </li>
                                    <li
                                        class="nav-item {{ request()->is('report/leave') ? 'active' : '' }}">
                                        <a class="nav-link"
                ...
                -->
                                    <li
                                        class="nav-item {{ request()->is('report/timesheet') ? 'active' : '' }}">
                                        <a class="nav-link"
                ...
                @if (Gate::check('Manage Department') ||
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::route()->getName() == 'department.index' ||
                        ...
                        Request::route()->getName() == 'job-stage.index'
                            ...
                            aria-expanded="{{ Request::route()->getName() == 'department.index' ||
                            Request::route()->getName() == 'designation.index' ||
                            Request::route()->getName() == 'document.index' ||
                            Request::route()->getName() == 'branch.index' ||
                            Request::route()->getName() == 'awardtype.index' ||
                        ...
                        <div class="collapse {{ Request::route()->getName() == 'department.index' ||
                        Request::route()->getName() == 'designation.index' ||
                        Request::route()->getName() == 'document.index' ||
                        Request::route()->getName() == 'branch.index' ||
                        Request::route()->getName() == 'awardtype.index' ||
                        ...
                        Request::route()->getName() == 'job-stage.index'
                            ...
                            <ul class="nav flex-column submenu-ul">
                                <li
                                    class="nav-item {{ request()->is('working-days*') ? 'active' : '' }}">
                                    <a class="nav-link"
                                        href="{{ route('working-day.index') }}">{{ __('Working days') }}</a>
                                </li>
                                @can('Manage Branch')
                                    <li
                                        class="nav-item {{ request()->is('branch*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                ...
                                @can('Manage Department')
                                    <li
                                        class="nav-item {{ request()->is('department*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                ...
                                @can('Manage Designation')
                                    <li
                                        class="nav-item {{ request()->is('designation*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                ...
                                @can('Manage Award Type')
                                    <li
                                        class="nav-item {{ request()->is('awardtype*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                ...
                                @can('Manage Termination Types')
                                    <li
                                        class="nav-item {{ request()->is('terminationtype*') ? 'active' : '' }}">
                                        <a class="nav-link"
        ...
        -->
                                @can('Manage Leave Type')
                                    <li
                                        class="nav-item {{ request()->is('leavetype*') ? 'active' : '' }}">
                                        <a class="nav-link"
                                ...
                                @can('Manage Goal Type')
                                    <li
                                        class="nav-item {{ request()->is('goaltype*') ? 'active' : '' }}">
                                        <a class="nav-link"
        ...
        -->
                                <li
                                    class="nav-item {{ request()->is('performanceType*') ? 'active' : '' }}">
                                    <a class="nav-link"
                                ...
                                @can('Manage Competencies')
                                    <li
                                        class="nav-item {{ request()->is('competencies*') ? 'active' : '' }}">
                                        <a class="nav-link"
