                        ...
                        <center>
                            <div class="row">
                                <div class="col-md-6 float-right border-right">
                                    ...
                                    @if(empty($employeeAttendance) || $employeeAttendance->clock_out != '00:00:00' AND !$employeeIsLate)
                                ...
                                <div class="col-md-6 float-left">
                                    @if(!empty($employeeAttendance) && $employeeAttendance->clock_out == '00:00:00')
                                        ...
                                        @if ($settings['company_end_time'] > now())
                                            <button type="submit" value="1" name="out" id="clock_out" class="btn-create badge-danger" onclick="return confirm('are sure you want clock out?')">{{__('CLOCK OUT')}}</button>
                                        @else
                        ...
                        <table class="table align-items-center">
                            ...
                            <tbody class="list">
                                @foreach ($leaveData as $leave)
                                    <tr>
                                        <td>{{$leave['title']}}</td>
                                        <td>{{$leave['entitled_leaves']}}</td>
                                        <td>{{$leave['total_leaves_taken']}}</td>
                                        <td>{{( $leave['show_dashboard_balance'] == 'end_off_year') ? $leave['entitled_leaves'] - $leave['total_leaves_taken'] : $leave['total_leave_left']}}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
