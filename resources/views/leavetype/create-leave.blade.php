...
@section('content')
                ...
                <div class="card-body py-0">
                    <div class="row">
                                ...
                                <div class="tab">
                                    <div class="card " style="width:100%">
                                        <div class="card-header align-items-center d-flex justify-content-between"
                                            ...
                                            <legend class="mb-0"> Leave definition</legend>
                                        ...
                                        <div class="card-body collapse show" id="collapseExample1">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    {{ Form::label('title', __('Leave Type Name'), ['class' => 'form-control-label']) }}
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="days" id="days"  class="form-control"  placeholder="Enter Days / Year">
                                                </div>
                                            </div>

                                            {{-- <div class="col-md-12">
                                                 <!-- Multiple Select -->
                                                <select class="form-control multiple" id="multidelect" multiple="multiple">
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="leave_valid" id="inlineRadio1" value="Yes">
                                                            <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input mb-0" checked type="radio"
                                                                name="leave_valid" id="inlineRadio2" value="No">
                                ...
                                <div class="tab">
                                    <div class="card mt-3" style="width: 100%;">
                                        ...
                                        <div class="card-body collapse show" id="collapseExample2">
                                            <div class="col-md-12">
                                                {{-- <div class="form-group">
                                                <label for="accrued">Is time off entitlement accrued?</label>
                                                <select id="entitlement_accrued" class="form-control form-control-sm" name="" id="">
                                            ...
                                            <div class="form-group">
                                                <label for="accrue">When is time off entitlement accrue?</label>
                                                <select class="form-control form-control-sm" name="" id="entitlement_accrue_time">
                                            ...
                                            <div class="col-md-3 custom-control custom-checkbox">
                                                <input class="custom-control-input isscheck isscheck_User" id="accrued" name="permissions[]" type="checkbox" value="1">
                                                <label for="accrued" class="custom-control-label font-weight-500">Accrued at the start of the period</label><br>
                                            </div>
                                            <div class="col-md-3 custom-control custom-checkbox">
                                                <input class="custom-control-input isscheck isscheck_User" id="accrued1" name="permissions[]" type="checkbox" value="1">
                                                <label for="accrued1" class="custom-control-label font-weight-500">Accrued at the end of the period</label><br>
                                            </div> --}}
                                            </div>
                                             <div class="col-md-12">
                                                <div class="form-group">
                                            ...
                                            <div style="display:none;" id="employees_qualify_details" class="group_wrapper">
                                                <legend class="mb-0">Extra Days assign to certain employees (days)</legend>
                                                <table id="itemTable3" class="table">
                                                    ...
                                                    <tbody class="field_wrapper4">
                                                        <tr class="item3">
                                                            ...
                                                            <td><input type="number" value="0" class="form-control extra_day_for_employee"
                                                                    placeholder="Days"></td>
                                                            <td><a href="javascript:void(0);"
                                                                    class="add_button4 btn btn-sm btn-primary"
                                                ...
                                                <div style="display:none;" id="tenure_wrapper" class="group_wrapper">
                                                    ...
                                                    <table id="itemTable" class="table">
                                                        ...
                                                        <tbody class="field_wrapper">
                                                            <tr class="item">
                                                                <td><select class="form-control years_service" name="tenure_years_service"
                                                    ...
                                                    <select id="tenure_award" class="form-control form-control-sm"
                                                        name="tenure_award">
                                                        <option value="" disabled>---Select---</option>
                                                        <option value="pro-rated" selected>Tenure award is pro-rated for the anniversary year</option>
                                                        <option value="year_start">Tenure award is given as if the anniversary occured at the start of the time off year</option>
                                                        {{-- <option value="year_end">Tenure award is given as if the anniversary occured at the end of the time off year</option> --}}
                                                        <option value="exact_date">Tenure award is given at the anniversary date</option>
                                                        {{-- <option value="next_accrual_point">Tenure award is given at the next accrual point following the anniversary date</option> --}}
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-sm" name="value_round"
                                                        id="value_round">
                                                        <option value="round_half">Round up to nearest half</option>
                                                        <option value="round_2_decimal">Round to 2 decimal places</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-sm" name=""
                                                        ...
                                                        <option value="half_days">Half day</option>
                                            ...
                                            <div class="col-md-12 parent">
                                                <div class="form-group">
                                                    ...
                                                    <select id="date_join" class="form-control form-control-sm"
                                                        >
                                                        <option value="" selected disabled>---Select---</option>
                                                        <option value="anniversary">On the anniversary of the employee's
                                                ...
                                                <div id="date_join_show" style="display: none;" class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" id="specific_date" value="{{date('Y-m-d')}}">
                                                    </div>
                                                </div>
                                                ...
                                                {{-- <div class="form-group">
                                                    <label for="cat">How soon after joining the organization can employees take time off?</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="soon_employees_take_leave">How soon after joining the organization can employees take time off? (No. of days)</label>
                                                    <input class="form-control" id="soon_employees_take_leave" type="number" placeholder="After Days" value="0">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="approves" class="form-control form-control-sm"
                                                        ...
                                                        <option selected value="hr">Hr management</option>
                                                        <option selected value="manager">Their Manager</option>
                                                    </select>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-12" id="when_carry_over_expire_div">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="When_carry_over_expire" class="form-control form-control-sm"
                                                                ...
                                                                <option value="1">1 months after the end of the time off year</option>
                                                                <option value="2">2 months after the end of the time off year</option>
                                                                <option value="3">3 months after the end of the time off year</option>
                                                                <option value="4">4 months after the end of the time off year</option>
                                                                <option value="5">5 months after the end of the time off year</option>
                                                                <option value="6">6 months after the end of the time off year</option>
                                                                <option value="7">7 months after the end of the time off year</option>
                                                                <option value="8">8 months after the end of the time off year</option>
                                                                <option value="9">9 months after the end of the time off year</option>
                                                                <option value="10">10 months after the end of the time off year</option>
                                                                <option value="11">11 months after the end of the time off year</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="carry_over" class="form-control form-control-sm"
                                                                ...
                                                                <option value="limit">Limited to a certain number of days</option>
                                                            </select>
                                                        </div>

                                                        <div class="form-group" id="carried_over_days_div">
                                                            <label for="carried_over_days">Enter number of days</label>
                                                            <input type="number" name="carried_over_days" id="carried_over_days" value="0">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab">
                                    <div class="card " style="width:100%">
                                        ...
                                        <div class="card-body collapse show" id="collapseExample1">
                                            ...
                                            <div class="col-md-12" id="entitlement_time_off_field" style="display: none;">
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select id="when_entitlement_time_off_at" class="form-control form-control-sm"
                                                        name="">
                                                        <option value="null" selected disabled>---Select---</option>
                                                        <option value="start">Accrued at the start of the period</option>
                                                        <option value="end">Accrued at the end of the period</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select id="how_entitlement_time_off" class="form-control form-control-sm"
                                                        name="" id="">
                                                        <option value="null" selected disabled>---Select---</option>
                                                        <option value="day">Accrue time off evenly across each working day</option>
                                                        <option value="month">Accrue time off evenly across each month
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="form-group mb-0 col-md-12" id="can_take_entitlement_time_off_field" style="display: none;">
                                                        ...
                                                        name="">
                                                            <option value="null" selected disabled>---Select---</option>
                                                            <option value="1">Limited to a certain number of days</option>
                                                        ...
                                                        <div class="form-group mb-0 col-md-12"  id="can_take_entitlement_time_off_field2" style="display: none;">
                                                            ...
                                                            <input type="number" name="borrowed_entitlement_time_off" id="borrowed_entitlement_time_off" placeholder="Enter No. of days" value="0">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select id="show_dashboard_balance" class="form-control form-control-sm"
                                                        ...
                                                        <option value="null" selected disabled>---Select---</option>
                                                        <option value="end_off_year">Show balance to end of time off year</option>
                                                        <option value="off_today">Show balance to today (currently accrued, available)</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="form-group mb-0 col-md-12" id="apply_upper_limit_entitlement_time_off_field" style="display: none;"  >
                                                        <label for="borrowed_entitlement_time_off_accrual_cap">accrual cap?(days)</label>
                                                        <input type="number" name="borrowed_entitlement_time_off_accrual_cap" id="borrowed_entitlement_time_off_accrual_cap" placeholder="Enter No. of days" value="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="form-group mb-0 col-md-12" id="set_leave_amount_immediately_field" style="display: none;">
                                                        ...
                                                        <input type="number" name="set_leave_amount_immediately_specify" id="set_leave_amount_immediately_specify" placeholder="Enter No. of days" value="0">
                                                    </div>
                                                </div>
                                            ...
                                            {{-- <td>
                                                <input type="number" class="form-control set_bulk_leave_days" placeholder="Additional days" value="0">
                                            </td> --}}
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select id="policy_wording" class="form-control form-control-sm"
                                                        name="policy_wording">
                                                        <option value="policy-generated" selected>Yes</option>
                                                        <option value="specify-wording">No </option>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group mb-0 policy-radio">
                                                    ...
                                                    <div class="">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="annual_allowance_exceeded" id="annual_allowance_exceeded" value="1">
                                                            <label class="form-check-label" for="annual_allowance_exceeded">Send for approval</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input mb-0" checked type="radio"
                                                                name="annual_allowance_exceeded" id="annual_allowance_exceeded2" value="0">
                                                ...
                                                <div class="form-group mb-0 policy-radio">
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="more_than_accrued" id="more_than_accrued" value="1">
                                                            <label class="form-check-label" for="more_than_accrued">Send for approval</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input mb-0" checked type="radio"
                                                                name="more_than_accrued" id="more_than_accrued2" value="0">
                                                ...
                                                <div class="form-group mb-0 policy-radio">
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="notice_given" id="notice_given" value="1">
                                                            <label class="form-check-label" for="notice_given">Send for approval</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input mb-0" checked type="radio"
                                                                name="notice_given" id="notice_given2" value="0">
                                                ...
                                                <div class="form-group mb-0 policy-radio">
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="probation_period" id="probation_period" value="1">
                                                            <label class="form-check-label" for="probation_period">Send for approval</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input mb-0" checked type="radio"
                                                                name="probation_period" id="probation_period2" value="0">
                                                ...
                                                <div class="form-group mb-0 policy-radio">
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="blackout_day" id="blackout_day" value="1">
                                                            <label class="form-check-label" for="blackout_day">Send for approval</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input mb-0" checked type="radio"
                                                                name="blackout_day" id="blackout_day2"  value="0">
                        ...
                        <div class="col-md-12" id="previewTab" style="display:none;">
                            ...
                            <p id="preview"></p>
                            <form action="{{route('leavetype.store')}}" method="post" id="regForm">
                                @csrf <!-- {{ csrf_field() }} -->
    ...
    <script>
        ...
        // $("#specific_date").val(new Date().toDateInputValue());
    ...
    <script>
        ...
        '<td> <a href="javascript:void(0);" class="remove_button4 btn btn-sm btn-danger"><i class="fa fa-minus"></i></a> </td>' +
        '</tr>';
        ...
        function getAllData(n) {
            ...
            if (date_join.val() == 'specific_date') {
            ...
            var htmlpreview = '<div class="row"><div class="col-md-12">';
            htmlpreview += '<div class="row main-row">'+
                                '<div class="col-md-12">'+
                                    '<h6>'+req["title"]+'</h6>'+
                                '</div>'+
        ...
        if (req["when_entitlement_time_off"] !== 'NA') {        
            htmlpreview += '<div class="row main-row">'+
                                '<div class="col-md-12">'+
                                    '<h6>Leave  Accural </h6>'+
                                '</div>'+
