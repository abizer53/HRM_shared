        ...
        @can('Create Performance Type')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('performanceType.create') }}"
                    ...
                    data-title="{{ __('Create Performance Type') }}">
                                    ...
                                    <td class="Action">
                                        <span>
                                            ...
                                            @can('Edit Performance Type')
                                                <a href="#" data-url="{{ URL::to('performanceType/'.$performance_type->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Performance Type')}}" class="edit-icon" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fas fa-pencil-alt"></i></a>
                                            @endcan
