                                                        ...
                                                        @endphp
                                                            <tr>
                                                                ...
                                                                <td>{{ucfirst($allownace->type)}}</td>
                                                                    ...
                                                                    @else
                                                                    <td>{{ ($allownace->amount)}}% (${{ $empallow }})</td>
                                                                    @endif
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
                                                        ...
                                                        @endphp
                                                            <tr>
                                                                ...
                                                                <td>{{ucfirst($commission->type)}}</td>
                                                                    ...
                                                                    @else
                                                                        <td>{{ ($commission->amount)}}% (${{ $empcomm }})</td>
                                                                    @endif
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
                                                        ...
                                                        @endphp
                                                            <tr>
                                                                ...
                                                                <td>{{ucfirst($deduction->type)}}</td>
                                                                    ...
                                                                    @else
                                                                        <td>{{ ($deduction->amount)}}%  (${{ $empdeduction }})</td>
                                                                    @endif
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
                                                        ...
                                                        @endphp
                                                            <tr>
                                                                ...
                                                                <td>{{ucfirst($payment->type)}}</td>
                                                                    ...
                                                                    @else
                                                                        <td>{{ ($payment->amount)}}% (${{ $emppayment }})</td>
                                                                    @endif
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
