                            ...
                            <div class="dropdown action-item">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    @can('Delete User')
                                        ...
                                        {!! Form::close() !!}
                                    @endcan
                                    <a href="#"  class="dropdown-item text-sm"  data-url="{{route('user.reset',\Crypt::encrypt($user->id))}}" data-ajax-popup="true" data-title="{{__('Reset Password')}}" data-toggle="tooltip" data-original-title="{{__('Reset Password')}}">{{__('Reset Password')}}
                                    </a>
                                </div>
                            </div>
                        </div>
