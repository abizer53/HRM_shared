...
//payslipupload new controller
Route::resource('payslipupload', 'PayslipUploadController')->middleware(
    [
        'auth',
        'XSS',
    ]
...
//Route::get('/payslipupload', function () {
//    return view('index');
//})->middleware(['auth','XSS',])->name('payslipupload');
...
//wokring days Controller
Route::get('/working-days', 'WorkingDayController@index')->name('working-day.index');
Route::post('/working-days/update', 'WorkingDayController@update')->name('working-day.update');

Route::get('fetch-leave-type/{id}', 'LeaveController@fetchLeaveType')->name('leave-type.fetch');