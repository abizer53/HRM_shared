        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Performance Type')): ?>
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="<?php echo e(route('performanceType.create')); ?>"
                    ...
                    data-title="<?php echo e(__('Create Performance Type')); ?>">
                                    ...
                                    <td class="Action">
                                        <span>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Performance Type')): ?>
                                                <a href="#" data-url="<?php echo e(URL::to('performanceType/'.$performance_type->id.'/edit')); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Edit Performance Type')); ?>" class="edit-icon" data-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>"><i class="fas fa-pencil-alt"></i></a>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/splashho/public_html/hrmsys/resources/views/performance_type/index.blade.php ENDPATH**/ ?>