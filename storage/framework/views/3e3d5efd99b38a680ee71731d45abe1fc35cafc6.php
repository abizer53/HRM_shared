...
<div class="row">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
        <div class="card card-box">
            ...
            <div class="user-text">
                ...
                <h2><?php echo e($countOpenTicket); ?>  </h2>
            </div>
            <img src="<?php echo e(asset('assets/img/dot-icon.png')); ?>" alt="" class="dotted-icon"/>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
        <div class="card card-box">
            <div class="left-card nowrap_text">
                <div class="icon-box"><i class="fas fa-ticket-alt"></i></div>
                <h4><?php echo e(__('On Hold Ticket')); ?></h4>
            </div>
            <div class="number-icon"></div>
            <div class="user-text">
                
                <h2><?php echo e($countonholdTicket); ?> </h2>
            </div>
            <img src="<?php echo e(asset('assets/img/dot-icon.png')); ?>" alt="" class="dotted-icon"/>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
        <div class="card card-box">
            <div class="left-card nowrap_text">
                <div class="icon-box"><i class="fas fa-ticket-alt"></i></div>
                <h4><?php echo e(__('Close  Ticket')); ?></h4>
            </div>
            <div class="number-icon"></div>
            <div class="user-text">
                
                <h2> <?php echo e($countCloseTicket); ?> </h2>
            </div>
            <img src="<?php echo e(asset('assets/img/dot-icon.png')); ?>" alt="" class="dotted-icon"/>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/q5w20afri03w/public_html/hrm/resources/views/ticket/index.blade.php ENDPATH**/ ?>