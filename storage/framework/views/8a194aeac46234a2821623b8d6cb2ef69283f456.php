                                        ...
                                        <div class="card-body collapse show" id="collapseExample1">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="cat"> <?php echo e(__('Measure time off in days or hours?')); ?>

                                                    </label>
                                                    <select class="form-control form-control-sm" name=""
                                                        id="measure">
                                                        <option value="Days" <?php echo e($leavetype->measure == 'Days' ? 'selected' : ''); ?>>Days</option>
                                                        <option value="Hours" <?php echo e($leavetype->measure == 'Hours' ? 'selected' : ''); ?>>Hours</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::text('title', $leavetype->title, ['class' => 'form-control ', 'placeholder' => __('Enter Leave Type Name')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <?php echo e(Form::label('days', __('Days/Hours Per Year'), ['class' => 'form-control-label'])); ?>

                                                    <input type="number" name="days" id="days" value="<?php echo e($leavetype->days); ?>"  class="form-control"  placeholder="Enter Days / Year">
                                                </div>
                                            </div>
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="leave_valid" id="inlineRadio1" value="Yes" <?php echo e($leavetype->leave_valid == 'Yes' ? 'checked' : ''); ?>>
                                                            <label class="form-check-label" for="inlineRadio1">Yes</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="leave_valid" id="inlineRadio2" value="No" <?php echo e($leavetype->leave_valid == 'No' ? 'checked' : ''); ?>>
                                ...
                                <div class="tab">
                                    <div class="card mt-3" style="width: 100%;">
                                        <div class="card-header align-items-center d-flex justify-content-between"
                                            style="padding: 5px 15px;">
                                            <legend class="mb-0"> <?php echo e(__('Extra Days')); ?> </legend>
                                            <button class="btn rounded" type="button" data-toggle="collapse"
                                        ...
                                        <div class="card-body collapse show" id="collapseExample2">
                                             <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="employees_qualify" class="form-control form-control-sm"
                                                        name="">
                                                        <option value="yes" <?php echo e($leavetype->employees_qualify == 'yes' ? 'selected' : ''); ?>>Yes</option>
                                                        <option value="no" <?php echo e($leavetype->employees_qualify == 'no' ? 'selected' : ''); ?>>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                                        ...
                                                        <tr class="item3">
                                                            <td>
                                                                <select class="form-control selected_employee" name="employee">
                                                                    <?php echo e($emps = App\Models\Employee::orderBy('name')->get()); ?>
                                            ...
                                            <div class="col-md-12">
                                                 <div class="form-group">
                                                    ...
                                                    <select id="tenure" class="form-control form-control-sm">
                                                        ...
                                                        <option value="yes" <?php echo e($leavetype->tenure == 'yes' ? 'selected' : ''); ?>>Yes</option>
                                                        <option value="no" <?php echo e($leavetype->tenure == 'no' ? 'selected' : ''); ?>>No</option>
                                                    </select>
                                                ...
                                                <div style="display:none;" id="tenure_wrapper" class="group_wrapper">
                                                    ...
                                                    <select id="tenure_award" class="form-control form-control-sm"
                                                        ...
                                                        <option value="pro-rated" <?php echo e($leavetype->tenure_award == 'pro-rated' ? 'selected' : ''); ?>>Tenure award is pro-rated for the anniversary year</option>
                                                        <option value="year_start" <?php echo e($leavetype->tenure_award == 'year_start' ? 'selected' : ''); ?>>Tenure award is given as if the anniversary occured at the start of the time off year</option>
                                                        <option value="exact_date" <?php echo e($leavetype->tenure_award == 'exact_date' ? 'selected' : ''); ?>>Tenure award is given at the anniversary date</option>                                                        
                                                    </select>
                                                </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="cat"> <?php echo e(__('How should values be rounded?')); ?>

                                                    </label>
                                                    <select class="form-control form-control-sm" name="value_round"
                                                        id="value_round">
                                                        <option value="round_half"  <?php echo e($leavetype->value_round == 'round_half' ? 'selected' : ''); ?>>Round Upto nearest half</option>
                                                        <option value="round_2_decimal" <?php echo e($leavetype->value_round == 'round_2_decimal' ? 'selected' : ''); ?>>Round to 2 decimal places</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab">
                                    <div class="card mt-3" style="width: 100%;">
                                        <div class="card-header align-items-center d-flex justify-content-between"
                                            style="padding: 5px 15px;">
                                            <legend class="mb-0"> <?php echo e(__('Leave Calculation')); ?> </legend>
                                            <button class="btn rounded" type="button" data-toggle="collapse"
                                        ...
                                        <div class="card-body collapse show" id="collapseExample3">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-sm" name=""
                                                        id="requesting_time">
                                                        <option value="any" <?php echo e($leavetype->requesting_time == 'any' ? 'selected' : ''); ?>>Any</option>
                                                        <option value="whole_day" <?php echo e($leavetype->requesting_time == 'whole_day' ? 'selected' : ''); ?>>Whole day</option>
                                                        <option value="half_days" <?php echo e($leavetype->requesting_time == 'half_days' ? 'selected' : ''); ?>>Half day</option>
                                                        <option value="2_hours" <?php echo e($leavetype->requesting_time == '2_hours' ? 'selected' : ''); ?>>2 hours</option>
                                                        <option value="1_hours" <?php echo e($leavetype->requesting_time == '1_hours' ? 'selected' : ''); ?>>1 hour</option>
                                                        <option value="30_minutes" <?php echo e($leavetype->requesting_time == '30_minutes' ? 'selected' : ''); ?>>30 minutes</option>
                                                        <option value="20_minutes" <?php echo e($leavetype->requesting_time == '20_minutes' ? 'selected' : ''); ?>>20 minutes</option>
                                                        <option value="15_minutes" <?php echo e($leavetype->requesting_time == '15_minutes' ? 'selected' : ''); ?>>15 minutes</option>
                                                        <option value="10_minutes" <?php echo e($leavetype->requesting_time == '10_minutes' ? 'selected' : ''); ?>>10 minutes</option>
                                                        <option value="5_minutes" <?php echo e($leavetype->requesting_time == '5_minutes' ? 'selected' : ''); ?>>5 minutes</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-12 parent">
                                                <div class="form-group">
                                                    <label
                                                        for="cat"><?php echo e(__('When is the start date of each time off year?')); ?></label>
                                                    <select id="date_join" class="form-control form-control-sm"
                                                        >
                                                        <option value="" selected disabled>---Select---</option>
                                                        <option value="anniversary" <?php echo e($leavetype->date_join == 'anniversary' ? 'selected' : ''); ?>>On the anniversary of the employee's
                                                            starting date</option>
                                                        <option value="specific_date" <?php echo e($leavetype->date_join == 'specific_date' ? 'selected' : ''); ?>>On a specific date</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div id="date_join_show" style="display: none;" class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" id="specific_date" value="<?php echo e($leavetype->date_join); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 parent_delay mb-2 mx-0 px-0">
                                                    ...
                                                    <div id="delay_time_show" style="display: none;" class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control form-control-sm" name=""
                                                                id="month_delay">
                                                                <option value="1" <?php echo e($leavetype->month_delay == '1' ? 'selected' : ''); ?>>1 Month</option>
                                                                <option value="2" <?php echo e($leavetype->month_delay == '2' ? 'selected' : ''); ?>>2 Months</option>
                                                                <option value="3" <?php echo e($leavetype->month_delay == '3' ? 'selected' : ''); ?>>3 Months</option>
                                                                <option value="4" <?php echo e($leavetype->month_delay == '4' ? 'selected' : ''); ?>>4 Months</option>
                                                                <option value="5" <?php echo e($leavetype->month_delay == '5' ? 'selected' : ''); ?>>5 Months</option>
                                                                <option value="6" <?php echo e($leavetype->month_delay == '6' ? 'selected' : ''); ?>>6 Months</option>
                                                                <option value="7" <?php echo e($leavetype->month_delay == '7' ? 'selected' : ''); ?>>7 Months</option>
                                                                <option value="8" <?php echo e($leavetype->month_delay == '8' ? 'selected' : ''); ?>>8 Months</option>
                                                                <option value="9" <?php echo e($leavetype->month_delay == '9' ? 'selected' : ''); ?>>9 Months</option>
                                                                <option value="10" <?php echo e($leavetype->month_delay == '10' ? 'selected' : ''); ?>>10 Months</option>
                                                                <option value="11" <?php echo e($leavetype->month_delay == '11' ? 'selected' : ''); ?>>11 Months</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="soon_employees_take_leave" type="number" placeholder="After Days" value="<?php echo e($leavetype->soon_employees_take_leave); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="policy" class="form-control form-control-sm"
                                                        name="policy">
                                                        <option value="yes" <?php echo e($leavetype->policy == 'yes' ? 'selected' : ''); ?>>Yes</option>
                                                        <option value="no" <?php echo e($leavetype->policy == 'no' ? 'selected' : ''); ?>>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="notice_when_booking" class="form-control form-control-sm"
                                                        name="" id="">
                                                        <option value="yes" <?php echo e($leavetype->notice_when_booking == 'yes' ? 'selected' : ''); ?>>Yes</option>
                                                        <option value="no" <?php echo e($leavetype->notice_when_booking == 'no' ? 'selected' : ''); ?>>No</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="approves" class="form-control form-control-sm"
                                                        name="" id="">
                                                        <option value="admin" <?php echo e($leavetype->approves == 'admin' ? 'selected' : ''); ?>>Admin</option>
                                                        <option value="hr" <?php echo e($leavetype->approves == 'hr' ? 'selected' : ''); ?>>Hr management</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="notified" class="form-control form-control-sm"
                                                        name="notified" >
                                                        <option value="admin" <?php echo e($leavetype->notified == 'admin' ? 'selected' : ''); ?>>Admin</option>
                                                        <option selected value="hr" <?php echo e($leavetype->notified == 'hr' ? 'selected' : ''); ?>>Hr management</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="carry" class="form-control form-control-sm">
                                                        <option value="1" <?php echo e($leavetype->carry == '1' ? 'selected' : ''); ?>>Yes</option>
                                                        <option selected value="0" <?php echo e($leavetype->carry == '0' ? 'selected' : ''); ?>>No</option>
                                                    </select>
                                                </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="carry_over_expire" class="form-control form-control-sm">
                                                                <option value="yes" <?php echo e($leavetype->carry_over_expire == 'yes' ? 'selected' : ''); ?>>Yes</option>
                                                                <option selected value="no" <?php echo e($leavetype->carry_over_expire == 'no' ? 'selected' : ''); ?>>No</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12" id="when_carry_over_expire_div">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="When_carry_over_expire" class="form-control form-control-sm"
                                                                ...
                                                                <option value="1" <?php echo e($leavetype->When_carry_over_expire == '1' ? 'selected' : ''); ?>>1 months after the end of the time off year</option>
                                                                <option value="2" <?php echo e($leavetype->When_carry_over_expire == '2' ? 'selected' : ''); ?>>2 months after the end of the time off year</option>
                                                                <option value="3" <?php echo e($leavetype->When_carry_over_expire == '3' ? 'selected' : ''); ?>>3 months after the end of the time off year</option>
                                                                <option value="4" <?php echo e($leavetype->When_carry_over_expire == '4' ? 'selected' : ''); ?>>4 months after the end of the time off year</option>
                                                                <option value="5" <?php echo e($leavetype->When_carry_over_expire == '5' ? 'selected' : ''); ?>>5 months after the end of the time off year</option>
                                                                <option value="6" <?php echo e($leavetype->When_carry_over_expire == '6' ? 'selected' : ''); ?>>6 months after the end of the time off year</option>
                                                                <option value="7" <?php echo e($leavetype->When_carry_over_expire == '7' ? 'selected' : ''); ?>>7 months after the end of the time off year</option>
                                                                <option value="8" <?php echo e($leavetype->When_carry_over_expire == '8' ? 'selected' : ''); ?>>8 months after the end of the time off year</option>
                                                                <option value="9" <?php echo e($leavetype->When_carry_over_expire == '9' ? 'selected' : ''); ?>>9 months after the end of the time off year</option>
                                                                <option value="10" <?php echo e($leavetype->When_carry_over_expire == '10' ? 'selected' : ''); ?>>10 months after the end of the time off year</option>
                                                                <option value="11" <?php echo e($leavetype->When_carry_over_expire == '11' ? 'selected' : ''); ?>>11 months after the end of the time off year</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="carry_over" class="form-control form-control-sm">
                                                                <option value="null" disabled>---Select---</option>
                                                                <option value="no_limit" <?php echo e($leavetype->carry_over == 'no_limit' ? 'selected' : ''); ?>>No limit</option>
                                                                <option value="limit" <?php echo e($leavetype->carry_over == 'limit' ? 'selected' : ''); ?>>Limited to a certain number of days</option>
                                                            </select>
                                                        </div>

                                                        <div class="form-group" id="carried_over_days_div">
                                                            <label for="carried_over_days">Enter number of days</label>
                                                            <input type="number" name="carried_over_days" id="carried_over_days" value="<?php echo e($leavetype->carried_over_days); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body collapse show" id="collapseExample1">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select id="entitlement_time_off" class="form-control form-control-sm">
                                                        <option value="1" <?php echo e($leavetype->entitlement_time_off == "1" ? 'selected' : ''); ?>>Yes</option>
                                                        <option value="0" <?php echo e($leavetype->entitlement_time_off == "0" ? 'selected' : ''); ?>>NO </option>
                                                    </select>
                                            ...
                                            <div class="col-md-12" id="entitlement_time_off_field" style="display: none;">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select id="when_entitlement_time_off" class="form-control form-control-sm">
                                                        <option value="null" disabled  <?php echo e($leavetype->when_entitlement_time_off == 'null' ? 'selected' : ''); ?>>---Select---</option>
                                                        <option value="monthly" <?php echo e($leavetype->when_entitlement_time_off == 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                                                        <option value="quarterly" <?php echo e($leavetype->when_entitlement_time_off == 'quarterly' ? 'selected' : ''); ?>>Quarterly</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select id="when_entitlement_time_off_at" class="form-control form-control-sm">
                                                        <option value="null" disabled <?php echo e($leavetype->when_entitlement_time_off_at == 'null' ? 'selected' : ''); ?>>---Select---</option>
                                                        <option value="start" <?php echo e($leavetype->when_entitlement_time_off_at == 'start' ? 'selected' : ''); ?>>Accrued at the start of the period</option>
                                                        <option value="end" <?php echo e($leavetype->when_entitlement_time_off_at == 'end' ? 'selected' : ''); ?>>Accrued at the end of the period</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select id="how_entitlement_time_off" class="form-control form-control-sm">
                                                        <option value="null" disabled <?php echo e($leavetype->how_entitlement_time_off == 'null' ? 'selected' : ''); ?>>---Select---</option>
                                                        <option value="day" <?php echo e($leavetype->how_entitlement_time_off == 'day' ? 'selected' : ''); ?>>Accrue time off evenly across each working day</option>
                                                        <option value="month" <?php echo e($leavetype->how_entitlement_time_off == 'month' ? 'selected' : ''); ?>>Accrue time off evenly across each month
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select id="can_take_entitlement_time_off" class="form-control form-control-sm"
                                                        name="" id="">
                                                        <option value="1" <?php echo e($leavetype->can_take_entitlement_time_off == "1" ? 'selected' : ''); ?>>yes</option>
                                                        <option value="0" <?php echo e($leavetype->can_take_entitlement_time_off == "0" ? 'selected' : ''); ?>>no</option>
                                                    </select>
                                                    <div class="form-group mb-0 col-md-12" id="can_take_entitlement_time_off_field" style="display: none;">
                                                        ...
                                                        <select id="borrowed_entitlement_time_off_limit" class="form-control form-control-sm">
                                                            <option value="null" disabled <?php echo e($leavetype->borrowed_entitlement_time_off_limit == 'null' ? 'selected' : ''); ?>>---Select---</option>
                                                            <option value="1" <?php echo e($leavetype->borrowed_entitlement_time_off_limit == '1' ? 'selected' : ''); ?>>Limited to a certain number of days</option>
                                                            <option value="0" <?php echo e($leavetype->borrowed_entitlement_time_off_limit == '0' ? 'selected' : ''); ?>>No limit</option>
                                                        </select>
                                                        ...
                                                        <div class="form-group mb-0 col-md-12" id="can_take_entitlement_time_off_field2" style="display: none;">
                                                            ...
                                                            <input type="number" name="borrowed_entitlement_time_off" id="borrowed_entitlement_time_off" placeholder="Enter No. of days" value="<?php echo e($leavetype->borrowed_entitlement_time_off ?? '0'); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select id="show_dashboard_balance" class="form-control form-control-sm"
                                                        ...
                                                        <option value="null" disabled <?php echo e($leavetype->show_dashboard_balance == 'null' ? 'selected' : ''); ?>>---Select---</option>
                                                        <option value="end_off_year" <?php echo e($leavetype->show_dashboard_balance == 'end_off_year' ? 'selected' : ''); ?>>Show balance to end of time off year</option>
                                                        <option value="off_today" <?php echo e($leavetype->show_dashboard_balance == 'off_today' ? 'selected' : ''); ?>>Show balance to today (currently accrued, available)</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select id="apply_upper_limit_entitlement_time_off" class="form-control form-control-sm"
                                                        ...
                                                        <option value="1" <?php echo e($leavetype->apply_upper_limit_entitlement_time_off == "1" ? 'selected' : ''); ?>>yes</option>
                                                        <option value="0" <?php echo e($leavetype->apply_upper_limit_entitlement_time_off == "0" ? 'selected' : ''); ?>>no</option>
                                                    </select>
                                                    <div class="form-group mb-0 col-md-12" id="apply_upper_limit_entitlement_time_off_field" style="display: none;"  >
                                                        ...
                                                        <input type="number" name="borrowed_entitlement_time_off_accrual_cap" id="borrowed_entitlement_time_off_accrual_cap" placeholder="Enter No. of days" value="<?php echo e($leavetype->borrowed_entitlement_time_off_accrual_cap ?? '0'); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <select id="set_leave_amount_immediately" class="form-control form-control-sm">
                                                        <!-- <option value="" selected disabled>---Select---</option> -->
                                                        <option value="1" <?php echo e($leavetype->set_leave_amount_immediately == '1' ? 'selected' : ''); ?>>yes</option>
                                                        <option value="0" <?php echo e($leavetype->set_leave_amount_immediately == '0' ? 'selected' : ''); ?>>no</option>
                                                    </select>
                                                    <div class="form-group mb-0 col-md-12" id="set_leave_amount_immediately_field" style="display: none;">
                                                        ...
                                                        <input type="number" name="set_leave_amount_immediately_specify" id="set_leave_amount_immediately_specify" placeholder="Enter No. of days" value="<?php echo e($leavetype->set_leave_amount_immediately_specify ?? '0'); ?>">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <select id="set_bulk_leave_amount" class="form-control form-control-sm"
                                                    ...
                                                    <option value="yes" <?php echo e($leavetype->set_bulk_leave_amount == 'yes' ? 'selected' : ''); ?>>yes</option>
                                                    <option selected value="no" <?php echo e($leavetype->set_bulk_leave_amount == 'no' ? 'selected' : ''); ?>>no</option>
                                                </select>
                                            </div>
                                            ...
                                            <div style="display:none;" id="set_bulk_leave_amount_wrapper" class="group_wrapper">
                                                ...
                                                <select class="form-control set_bulk_leave_month" name="bulk_leave_after_month"
                                                    ...
                                                    <option value="1" <?php echo e($leavetype->bulk_leave_after_month == '1' ? 'selected' : ''); ?>>1 Month</option>
                                                    <option value="2" <?php echo e($leavetype->bulk_leave_after_month == '2' ? 'selected' : ''); ?>>2 Month</option>
                                                    <option value="3" <?php echo e($leavetype->bulk_leave_after_month == '3' ? 'selected' : ''); ?>>3 Month</option>
                                                    <option value="4" <?php echo e($leavetype->bulk_leave_after_month == '4' ? 'selected' : ''); ?>>4 Month</option>
                                                    <option value="5" <?php echo e($leavetype->bulk_leave_after_month == '5' ? 'selected' : ''); ?>>5 Month</option>
                                                    <option value="6" <?php echo e($leavetype->bulk_leave_after_month == '6' ? 'selected' : ''); ?>>6 Month</option>
                                                    <option value="7" <?php echo e($leavetype->bulk_leave_after_month == '7' ? 'selected' : ''); ?>>7 Month</option>
                                                    <option value="8" <?php echo e($leavetype->bulk_leave_after_month == '8' ? 'selected' : ''); ?>>8 Month</option>
                                                    <option value="9" <?php echo e($leavetype->bulk_leave_after_month == '9' ? 'selected' : ''); ?>>9 Month</option>
                                                    <option value="10" <?php echo e($leavetype->bulk_leave_after_month == '10' ? 'selected' : ''); ?>>10 Month</option>
                                                    <option value="11" <?php echo e($leavetype->bulk_leave_after_month == '11' ? 'selected' : ''); ?>>11 Month</option>
                                                    <option value="12" <?php echo e($leavetype->bulk_leave_after_month == '12' ? 'selected' : ''); ?>>12 Month</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body collapse show" id="collapseExample1">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input type="color" value="<?php echo e($leavetype->color); ?>" name="color" id="color">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group mb-0 policy-radio">
                                                    ...
                                                    <div class="">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="annual_allowance_exceeded" id="annual_allowance_exceeded" value="1" <?php echo e($leavetype->annual_allowance_exceeded == '1' ? 'checked' : ''); ?>>
                                                            <label class="form-check-label" for="annual_allowance_exceeded">Send for approval</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="annual_allowance_exceeded" id="annual_allowance_exceeded2" value="0" <?php echo e($leavetype->annual_allowance_exceeded == '0' ? 'checked' : ''); ?>>
                                                ...
                                                <div class="form-group mb-0 policy-radio">
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="more_than_accrued" id="more_than_accrued" value="1" <?php echo e($leavetype->more_than_accrued == '1' ? 'checked' : ''); ?>>
                                                            <label class="form-check-label" for="more_than_accrued">Send for approval</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="more_than_accrued" id="more_than_accrued2" value="0" <?php echo e($leavetype->more_than_accrued == '0' ? 'checked' : ''); ?>>
                                                ...
                                                <div class="form-group mb-0 policy-radio">
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="notice_given" id="notice_given" value="1" <?php echo e($leavetype->notice_given == '1' ? 'checked' : ''); ?>>
                                                            <label class="form-check-label" for="notice_given">Send for approval</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="notice_given" id="notice_given2" value="0" <?php echo e($leavetype->notice_given == '0' ? 'checked' : ''); ?>>
                                                ...
                                                <div class="form-group mb-0 policy-radio">
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="probation_period" id="probation_period" value="1" <?php echo e($leavetype->probation_period == '1' ? 'checked' : ''); ?>>
                                                            <label class="form-check-label" for="probation_period">Send for approval</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="probation_period" id="probation_period2" value="0" <?php echo e($leavetype->probation_period == '0' ? 'checked' : ''); ?>>
                                                ...
                                                <div class="form-group mb-0 policy-radio">
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="blackout_day" id="blackout_day" value="1" <?php echo e($leavetype->blackout_day == '1' ? 'checked' : ''); ?>>
                                                            <label class="form-check-label" for="blackout_day">Send for approval</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input mb-0" type="radio"
                                                                name="blackout_day" id="blackout_day2"  value="0" <?php echo e($leavetype->blackout_day == '0' ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-12" id="previewTab" style="display:none;">
                            ...
                            <p id="preview"></p>
                            <form action="<?php echo e(route('leavetype.update', $leavetype->id)); ?>" method="post" id="regForm">
    ...
    <script>
      $(function () {
       ...
       $(document).ready(function() {
            if ("<?php echo e($leavetype->employees_qualify); ?>" == "yes") {

                $("#employees_qualify_details").show();
                
                var html_fields4_exit = ''
                var emp_qualifies = <?php echo json_encode($leavetype->employees_qualifies); ?>;                    
                var emps = <?php echo $emps; ?>;
            ...
            if ("<?php echo e($leavetype->tenure); ?>" == "yes") {

                $("#tenure_wrapper").show();

                var html_fields_exit = ''
                var tenures = <?php echo json_encode($leavetype->tenure_in_leaves); ?>;                    
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/q5w20afri03w/public_html/hrm/resources/views/leavetype/edit.blade.php ENDPATH**/ ?>