...
unset($__errorArgs, $__bag); ?>
            ...
            <h5 class="copyright-text">
                <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright HRMGo')); ?> 
                <!--<?php echo e(date('Y')); ?> -->
            </h5>
            <!--
            COMMENT OUT LANGUAGE CHANGE
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u397867700/domains/inov2elate.net/public_html/hrm/resources/views/auth/login.blade.php ENDPATH**/ ?>