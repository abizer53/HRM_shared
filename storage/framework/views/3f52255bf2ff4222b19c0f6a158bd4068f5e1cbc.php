    ...
    <div class="scrollbar-inner">
            ...
            <ul class="navbar-nav navbar-nav-docs">
                ...
                <?php else: ?>
                    <?php if(Gate::check('Manage User') ||
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(Request::route()->getName() == 'user.index' || Request::route()->getName() == 'roles.index' || Request::route()->getName() == 'permissions.index' || Request::route()->getName() == 'employee.profile' || Request::route()->getName() == 'lastlogin' ? 'active' : 'collapsed'); ?>"
                                href="#navbar-staff" data-toggle="collapse" role="button"
                                aria-expanded="<?php echo e(Request::route()->getName() == 'user.index' ||
                                Request::route()->getName() == 'roles.index' ||
                                Request::route()->getName() == 'permissions.index' ||
                                Request::route()->getName() == 'employee.profile' ||
                                Request::route()->getName() == 'lastlogin'
                                    ? 'true'
                                    : 'false'); ?>"
                            ...
                            <div class="collapse <?php echo e(Request::route()->getName() == 'user.index' || Request::route()->getName() == 'roles.index' || Request::route()->getName() == 'permissions.index' || Request::route()->getName() == 'employee.profile' || Request::route()->getName() == 'lastlogin' ? 'show' : ''); ?>"
                                id="navbar-staff">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Employee Profile')): ?>
                                        <li class="nav-item <?php echo e(request()->is('employee-profile') ? 'active' : ''); ?>">
                                            <a href="<?php echo e(route('employee.profile')); ?>"
                                                class="nav-link"><?php echo e(__('Employee Profile')); ?></a>
                                        </li>
                                    <?php endif; ?>
                    ...
                    <?php else: ?>
                        <li class="nav-item">
                            <a href="<?php echo e(route('employee.index')); ?>"
                                class="nav-link  <?php echo e(Request::route()->getName() == 'employee.index' || Request::route()->getName() == 'employee.create' || Request::route()->getName() == 'employee.edit' || Request::route()->getName() == 'employee.show' ? 'active' : ''); ?>">
                                <i class="fas fa-users"></i><?php echo e(__('Employee')); ?>
                ...
                <?php if(Gate::check('Manage Set Salary') || Gate::check('Manage Pay Slip')): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::route()->getName() == 'setsalary.index' || Request::route()->getName() == 'setsalary.show' || Request::route()->getName() == 'payslip.index' || Request::route()->getName() == 'payslipupload.index' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'setsalary.edit' || Request::route()->getName() == 'employeesalary' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'payslip.pdf' ? 'active' : 'collapsed'); ?>"
                            href="#navbar-payroll" data-toggle="collapse" role="button"
                            aria-expanded="<?php echo e(Request::route()->getName() == 'setsalary.index' ||
                            Request::route()->getName() == 'setsalary.show' ||
                            Request::route()->getName() == 'payslip.index' ||
                            Request::route()->getName() == 'payslip.employeepayslip' ||
                            Request::route()->getName() == 'setsalary.edit' ||
                            Request::route()->getName() == 'employeesalary' ||
                            Request::route()->getName() == 'payslip.employeepayslip' ||
                            Request::route()->getName() == 'payslip.pdf'
                                ? 'true'
                                : 'false'); ?>"
                            aria-controls="navbar-payroll">
                        ...
                        <div class="collapse <?php echo e(Request::route()->getName() == 'setsalary.index' || Request::route()->getName() == 'setsalary.show' || Request::route()->getName() == 'payslip.index' || Request::route()->getName() == 'payslipupload.index' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'setsalary.edit' || Request::route()->getName() == 'employeesalary' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'payslip.pdf' ? 'show' : ''); ?>"
                            ...
                            <ul class="nav flex-column submenu-ul">
                                ...
                                -->
                                <li class="nav-item <?php echo e(request()->is('payslipupload*') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('payslipupload.index')); ?>"
                                        class="nav-link"><?php echo e(__('Payslip Upload')); ?></a>
                                </li>
                ...
                <?php if(Gate::check('Manage Attendance') || Gate::check('Manage Leave') || Gate::check('Manage TimeSheet')): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::route()->getName() == 'attendanceemployee.index' || Request::route()->getName() == 'leave.index' || Request::route()->getName() == 'timesheet.index' || Request::route()->getName() == 'attendanceemployee.bulkattendance' ? 'active' : 'collapsed'); ?>"
                            href="#navbar-timesheet" data-toggle="collapse" role="button"
                            aria-expanded="<?php echo e(Request::route()->getName() == 'attendanceemployee.index' || Request::route()->getName() == 'leave.index' || Request::route()->getName() == 'timesheet.index' || Request::route()->getName() == 'attendanceemployee.bulkattendance' ? 'true' : 'false'); ?>"
                            aria-controls="navbar-timesheet">
                            <i class="fas fa-clock"></i><?php echo e(__('Attendance')); ?>

                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse <?php echo e(Request::route()->getName() == 'attendanceemployee.index' || Request::route()->getName() == 'leave.index' || Request::route()->getName() == 'timesheet.index' || Request::route()->getName() == 'attendanceemployee.bulkattendance' ? 'show' : ''); ?>"
                            id="navbar-timesheet">
                            <ul class="nav flex-column submenu-ul">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Attendance')): ?>
                                    <li
                                        class="nav-item <?php echo e(Request::route()->getName() == 'attendanceemployee.index' ? 'active' : ''); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Attendance')): ?>
                                    <li
                                        class="nav-item <?php echo e(Request::route()->getName() == 'attendanceemployee.bulkattendance' ? 'active' : ''); ?>">
                ...
                <?php if(Gate::check('Manage Indicator') || Gate::check('Manage Appraisal') || Gate::check('Manage Goal Tracking')): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::route()->getName() == 'indicator.index' || Request::route()->getName() == 'appraisal.index' || Request::route()->getName() == 'goaltracking.index' ? 'active' : 'collapsed'); ?>"
                            href="#navbar-performance" data-toggle="collapse" role="button"
                            aria-expanded="<?php echo e(Request::route()->getName() == 'indicator.index' || Request::route()->getName() == 'appraisal.index' || Request::route()->getName() == 'goaltracking.index' ? 'true' : 'false'); ?>"
                            aria-controls="navbar-performance">
                            <i class="fas fa-cube"></i><?php echo e(__('Performance')); ?>

                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse <?php echo e(Request::route()->getName() == 'indicator.index' || Request::route()->getName() == 'appraisal.index' || Request::route()->getName() == 'goaltracking.index' ? 'show' : ''); ?>"
                ...
                <?php if(Gate::check('Manage Awards') ||
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::route()->getName() == 'award.index' ||
                        Request::route()->getName() == 'transfer.index' ||
                        Request::route()->getName() == 'resignation.index' ||
                        Request::route()->getName() == 'travel.index' ||
                        Request::route()->getName() == 'promotion.index' ||
                        Request::route()->getName() == 'complaint.index' ||
                        Request::route()->getName() == 'warning.index' ||
                        Request::route()->getName() == 'termination.index' ||
                        Request::route()->getName() == 'holiday.index' ||
                        Request::route()->getName() == 'announcement.index'
                            ? 'active'
                            : 'collapsed'); ?>"
                            href="#navbar-hr" data-toggle="collapse" role="button"
                            aria-expanded="<?php echo e(Request::route()->getName() == 'award.index' ||
                            Request::route()->getName() == 'transfer.index' ||
                            Request::route()->getName() == 'resignation.index' ||
                            Request::route()->getName() == 'travel.index' ||
                            Request::route()->getName() == 'promotion.index' ||
                        ...
                        <div class="collapse <?php echo e(Request::route()->getName() == 'award.index' ||
                        Request::route()->getName() == 'transfer.index' ||
                        Request::route()->getName() == 'resignation.index' ||
                        Request::route()->getName() == 'travel.index' ||
                        Request::route()->getName() == 'promotion.index' ||
                ...
                <?php if(Gate::check('Manage Job') ||
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::route()->getName() == 'job.index' ||
                        Request::route()->getName() == 'job.create' ||
                        Request::route()->getName() == 'job.edit' ||
                        Request::route()->getName() == 'job.show' ||
                        Request::route()->getName() == 'job-application.index' ||
                        Request::route()->getName() == 'job-application.show' ||
                        Request::route()->getName() == 'job.application.candidate' ||
                        Request::route()->getName() == 'job.on.board' ||
                        Request::route()->getName() == 'job.on.board.convert' ||
                        Request::route()->getName() == 'custom-question.index' ||
                        Request::route()->getName() == 'interview-schedule.index'
                            ? 'active'
                            : 'collapsed'); ?>"
                           href="#navbar-recurtment" data-toggle="collapse" role="button"
                           aria-expanded="<?php echo e(Request::route()->getName() == 'job.index' ||
                           Request::route()->getName() == 'job.create' ||
                           Request::route()->getName() == 'job.edit' ||
                           Request::route()->getName() == 'job.show' ||
                           Request::route()->getName() == 'job-application.index' ||
                        ...
                        <div class="collapse <?php echo e(Request::route()->getName() == 'job.index' ||
                        Request::route()->getName() == 'job.create' ||
                        Request::route()->getName() == 'job.edit' ||
                        Request::route()->getName() == 'job.show' ||
                        Request::route()->getName() == 'job-application.index' ||
                ...
                <?php if(Gate::check('Manage Ticket') || Gate::check('Manage Meeting')): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::route()->getName() == 'chats' ||
                        request()->is('ticket*') ||
                        request()->is('meeting*') ||
                        Request::segment(1) == 'zoom-meeting'
                            ? 'active'
                            : 'collapsed'); ?>"
                            href="#navbar-social" data-toggle="collapse" role="button"
                            aria-expanded="<?php echo e(Request::route()->getName() == 'chats' ||
                            request()->is('ticket*') ||
                            request()->is('meeting*') ||
                            Request::segment(1) == 'zoom-meeting'
                                ? 'true'
                                : 'false'); ?>"
                            aria-controls="navbar-social">
                            <i class="fas fa-comments"></i><?php echo e(__('Social')); ?>

                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse <?php echo e(Request::route()->getName() == 'chats' ||
                        request()->is('ticket*') ||
                        request()->is('meeting*') ||
                        Request::segment(1) == 'zoom-meeting'
                            ? 'show'
                            ...
                            <ul class="nav flex-column submenu-ul">
                                ...
                                <?php if(\Auth::user()->type != 'super admin'): ?>
                                    <li
                                        class="nav-item <?php echo e(Request::route()->getName() == 'chats' ? 'active' : ''); ?>">
                                        <a href="<?php echo e(url('chats')); ?>" class="nav-link"><?php echo e(__('Messenger')); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Ticket')): ?>
                                    <li class="nav-item <?php echo e(request()->is('ticket*') ? 'active' : ''); ?>">
                                        <a href="<?php echo e(route('ticket.index')); ?>" class="nav-link"><?php echo e(__('Ticket')); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <li class="nav-item <?php echo e(Request::segment(1) == 'zoom-meeting' ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('zoom-meeting.index')); ?>"
                                        class="nav-link"><?php echo e(__('Zoom Meeting')); ?></a>
                                </li>
                ...
                <?php if(Gate::check('Manage Assets')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('account-assets.index')); ?>"
                            class="nav-link <?php echo e(Request::segment(1) == 'account-assets' ? 'active' : ''); ?>">
                ...
                <?php if(Gate::check('Manage Document')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('document-upload.index')); ?>"
                            class="nav-link <?php echo e(Request::segment(1) == 'document-upload' ? 'active' : ''); ?>">
                ...
                <?php if(Gate::check('Manage Company Policy')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('company-policy.index')); ?>"
                            class="nav-link <?php echo e(Request::segment(1) == 'company-policy' ? 'active' : ''); ?>">
                ...
                <?php if(Gate::check('Manage Plan')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('plans.index')); ?>"
                            class="nav-link <?php echo e(request()->is('plans*') ? 'active' : ''); ?>">
                ...
                <?php if(Gate::check('Manage Order')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('order.index')); ?>"
                            class="nav-link <?php echo e(request()->is('orders*') ? 'active' : ''); ?>">
                ...
                -->
                                    <li
                                        class="nav-item <?php echo e(request()->is('report/monthly/attendance') ? 'active' : ''); ?>">
                                        <a class="nav-link"
                                            href="<?php echo e(route('report.monthly.attendance')); ?>"><?php echo e(__('Monthly Attendance')); ?></a>
                                    </li>
                                    <li
                                        class="nav-item <?php echo e(request()->is('report/leave') ? 'active' : ''); ?>">
                                        <a class="nav-link"
                ...
                -->
                                    <li
                                        class="nav-item <?php echo e(request()->is('report/timesheet') ? 'active' : ''); ?>">
                                        <a class="nav-link"
                ...
                <?php if(Gate::check('Manage Department') ||
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::route()->getName() == 'department.index' ||
                        Request::route()->getName() == 'designation.index' ||
                        Request::route()->getName() == 'document.index' ||
                        Request::route()->getName() == 'branch.index' ||
                        Request::route()->getName() == 'awardtype.index' ||
                        Request::route()->getName() == 'terminationtype.index' ||
                        Request::route()->getName() == 'paysliptype.index' ||
                        Request::route()->getName() == 'allowanceoption.index' ||
                        Request::route()->getName() == 'loanoption.index' ||
                        Request::route()->getName() == 'deductionoption.index' ||
                        Request::route()->getName() == 'competencies.index' ||
                        Request::route()->getName() == 'performanceType.index' ||
                        Request::route()->getName() == 'expensetype.index' ||
                        Request::route()->getName() == 'incometype.index' ||
                        Request::route()->getName() == 'paymenttype.index' ||
                        Request::route()->getName() == 'leavetype.index' ||
                        Request::route()->getName() == 'goaltype.index' ||
                        Request::route()->getName() == 'trainingtype.index' ||
                        Request::route()->getName() == 'job-category.index' ||
                        Request::route()->getName() == 'job-stage.index'
                            ? 'active'
                            : 'collapsed'); ?>"
                            href="#navbar-constant" data-toggle="collapse" role="button"
                            aria-expanded="<?php echo e(Request::route()->getName() == 'department.index' ||
                            Request::route()->getName() == 'designation.index' ||
                            Request::route()->getName() == 'document.index' ||
                            Request::route()->getName() == 'branch.index' ||
                            Request::route()->getName() == 'awardtype.index' ||
                        ...
                        <div class="collapse <?php echo e(Request::route()->getName() == 'department.index' ||
                        Request::route()->getName() == 'designation.index' ||
                        Request::route()->getName() == 'document.index' ||
                        Request::route()->getName() == 'branch.index' ||
                        Request::route()->getName() == 'awardtype.index' ||
                        ...
                        Request::route()->getName() == 'job-stage.index'
                            ...
                            <ul class="nav flex-column submenu-ul">
                                <li
                                    class="nav-item <?php echo e(request()->is('working-days*') ? 'active' : ''); ?>">
                                    <a class="nav-link"
                                        href="<?php echo e(route('working-day.index')); ?>"><?php echo e(__('Working days')); ?></a>
                                </li>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Branch')): ?>
                                    <li
                                        class="nav-item <?php echo e(request()->is('branch*') ? 'active' : ''); ?>">
                                        <a class="nav-link"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Department')): ?>
                                    <li
                                        class="nav-item <?php echo e(request()->is('department*') ? 'active' : ''); ?>">
                                        <a class="nav-link"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Designation')): ?>
                                    <li
                                        class="nav-item <?php echo e(request()->is('designation*') ? 'active' : ''); ?>">
                                        <a class="nav-link"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Document Type')): ?>
                                    <li
                                        class="nav-item <?php echo e(request()->is('document*') ? 'active' : ''); ?>">
                                        <a class="nav-link"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Award Type')): ?>
                                    <li
                                        class="nav-item <?php echo e(request()->is('awardtype*') ? 'active' : ''); ?>">
                                        <a class="nav-link"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Termination Types')): ?>
                                    <li
                                        class="nav-item <?php echo e(request()->is('terminationtype*') ? 'active' : ''); ?>">
                                        <a class="nav-link"
        ...
        -->
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Leave Type')): ?>
                                    <li
                                        class="nav-item <?php echo e(request()->is('leavetype*') ? 'active' : ''); ?>">
                                        <a class="nav-link"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Goal Type')): ?>
                                    <li
                                        class="nav-item <?php echo e(request()->is('goaltype*') ? 'active' : ''); ?>">
                                        <a class="nav-link"
        ...
        -->
                                <li
                                    class="nav-item <?php echo e(request()->is('performanceType*') ? 'active' : ''); ?>">
                                    <a class="nav-link"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Competencies')): ?>
                                    <li
                                        class="nav-item <?php echo e(request()->is('competencies*') ? 'active' : ''); ?>">
                                        <a class="nav-link"
                ...
                <?php if(Gate::check('Manage Company Settings') || Gate::check('Manage System Settings')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('settings.index')); ?>"
                            class="nav-link <?php echo e(request()->is('settings*') ? 'active' : ''); ?>">
...
<?php /**PATH /home/q5w20afri03w/public_html/hrm/resources/views/partial/Admin/menu.blade.php ENDPATH**/ ?>