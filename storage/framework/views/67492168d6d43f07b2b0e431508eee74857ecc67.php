        ...
        <div class="all-button-box row d-flex justify-content-end mt-2">
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="all-button-box">
                    <a href="#" data-url="<?php echo e(route('holiday.create')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto"
                        data-ajax-popup="true" data-title="<?php echo e(__('Create New Holiday')); ?>">
            ...
            <div class="col-auto">
                <div class="all-button-box">
                    <a href="<?php echo e(route('holiday.calender')); ?>" class="action-btn" data-toggle="tooltip"
                        data-original-title="<?php echo e(__('Calender View')); ?>">
                ...
                <div class="card-body py-0">
                    ...
                    <div class="row d-flex justify-content-end mt-2">
                        ...
                        <div class="col-auto mt-auto mb-3">
                            ...
                            <a href="<?php echo e(route('holiday.index')); ?>" class="reset-btn" data-toggle="tooltip"
                                                ...
                                                <span>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Holiday')): ?>
                                                        <a href="#" class="edit-icon"
                                                            ...
                                                            data-ajax-popup="true" data-title="<?php echo e(__('Edit Holiday')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/q5w20afri03w/public_html/hrm/resources/views/holiday/index.blade.php ENDPATH**/ ?>