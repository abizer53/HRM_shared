    ...
    <?php if(\Auth::user()->type == 'employee'): ?>
        <div class="row">
            ...
            <div class="col-lg-6">
                        ...
                        <center>
                            <div class="row">
                                <div class="col-md-6 float-right border-right">
                                    ...
                                    <?php if(empty($employeeAttendance) || $employeeAttendance->clock_out != '00:00:00' AND !$employeeIsLate): ?>
                                ...
                                <div class="col-md-6 float-left">
                                    <?php if(!empty($employeeAttendance) && $employeeAttendance->clock_out == '00:00:00'): ?>
                                        ...
                                        <?php if($settings['company_end_time'] > now()): ?>
                                            <button type="submit" value="1" name="out" id="clock_out" class="btn-create badge-danger" onclick="return confirm('are sure you want clock out?')"><?php echo e(__('CLOCK OUT')); ?></button>
                                        <?php else: ?>
                ...
                <div class="card">
                    <div class="card-header">
                        <h4><?php echo e(__('Leave Details')); ?></h4>
                    </div>
                    <div class="card-body dash-card-body">
                        ...
                        <table class="table align-items-center">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('Total Leaves')); ?></th>
                                <th><?php echo e(__('Taken Leaves')); ?></th>
                                <th><?php echo e(__('Available Leaves')); ?></th>
                            </tr>
                            </thead>
                            <tbody class="list">
                                <?php $__currentLoopData = $leaveData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($leave['entitled_leaves']); ?></td>
                                        <td><?php echo e($leave['total_leaves_taken']); ?></td>
                                        <td><?php echo e(( $leave['show_dashboard_balance'] == 'end_off_year') ? $leave['entitled_leaves'] - $leave['total_leaves_taken'] : $leave['total_leave_left']); ?></td>
                                    </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/q5w20afri03w/public_html/hrm/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>