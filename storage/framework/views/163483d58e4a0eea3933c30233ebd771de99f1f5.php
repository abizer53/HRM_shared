                        ...
                        <div class="edit-profile user-text">
                            <div class="dropdown action-item">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <?php endif; ?>
                                    <a href="#"  class="dropdown-item text-sm"  data-url="<?php echo e(route('user.reset',\Crypt::encrypt($user->id))); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Reset Password')); ?>" data-toggle="tooltip" data-original-title="<?php echo e(__('Reset Password')); ?>"><?php echo e(__('Reset Password')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/abizer/hrmsys/resources/views/user/index.blade.php ENDPATH**/ ?>