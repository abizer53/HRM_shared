                        ...
                        <div class="collapse <?php echo e((Request::route()->getName() == 'setsalary.index' || Request::route()->getName() == 'setsalary.show' ||  Request::route()->getName() == 'payslip.index' ||  Request::route()->getName() == 'payslipupload.index' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'setsalary.edit' || Request::route()->getName() == 'employeesalary' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'payslip.pdf') ? 'show' : ''); ?>"
                            ...
                            <ul class="nav flex-column submenu-ul">
                                ...
                                <li class="nav-item <?php echo e(request()->is('payslipupload*') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('payslipupload.index')); ?>" class="nav-link"><?php echo e(__('Payslip Upload')); ?></a>
                                </li>
...
<!-- Function Not Needed
                ...
                <?php if(Gate::check('Manage Ticket') || Gate::check('Manage Meeting')): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e((Request::route()->getName() == 'chats' || request()->is('ticket*') || request()->is('meeting*') || Request::segment(1) == 'zoom-meeting') ?
                        'active' : 'collapsed'); ?>"
                           href="#navbar-social" data-toggle="collapse" role="button"
                           aria-expanded="<?php echo e((Request::route()->getName() == 'chats' || request()->is('ticket*') || request()->is('meeting*') || Request::segment(1) == 'zoom-meeting') ?
                           'true' : 'false'); ?>"
                        ...
                        <div class="collapse <?php echo e((Request::route()->getName() == 'chats' || request()->is('ticket*') || request()->is('meeting*') || Request::segment(1) == 'zoom-meeting') ?
                        'show' : ''); ?>"
                             id="navbar-social">
                            <ul class="nav flex-column submenu-ul">

				                <?php if(\Auth::user()->type != 'super admin'): ?>
				                    <li class="nav-item <?php echo e((Request::route()->getName() == 'chats') ? 'active' : ''); ?>">
				                ...
				                <?php endif; ?>
	                                ...
	                                <li class="nav-item <?php echo e((Request::segment(1) == 'zoom-meeting') ? 'active' : ''); ?>">                        
					                    <a href="<?php echo e(route('zoom-meeting.index')); ?>" class="nav-link"><?php echo e(__('Zoom Meeting')); ?></a>
					                </li>
...
<?php /**PATH /home/u397867700/domains/inov2elate.net/public_html/hrm/resources/views/partial/Admin/menu.blade.php ENDPATH**/ ?>