    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('title',null,array('class'=>'form-control','placeholder'=>__('Enter Ticket Subject'), 'required'=>'required'))); ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php echo e(Form::select('employee_id',$employees,null,array('class'=>'form-control select2','placeholder'=>__('Select Employee'),'required'=>'required'))); ?>
...
<?php /**PATH /home/q5w20afri03w/public_html/hrm/resources/views/ticket/create.blade.php ENDPATH**/ ?>