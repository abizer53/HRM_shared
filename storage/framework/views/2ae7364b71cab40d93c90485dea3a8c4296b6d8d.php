...
<?php $__env->startSection('action-button'); ?>
    ...
    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-12 col-12">
        <div class="all-button-box">
            <a href="<?php echo e(route('zoom_meeting.calender')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto"><i class="far fa-calendar-alt"></i> <?php echo e(__('Calendar View')); ?> </a>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo e($ZoomMeeting->start_url); ?>" target="_blank"> <?php echo e(__('Start meeting')); ?> <i class="fas fa-external-link-square-alt "></i></a>
                            <?php elseif($ZoomMeeting->checkDateTime()): ?>
                                <a href="<?php echo e($ZoomMeeting->join_url); ?>" target="_blank"> <?php echo e(__('Join meeting')); ?> <i class="fas fa-external-link-square-alt "></i></a>
                            <?php else: ?>
                                -
                            <?php endif; ?>
                        </td>
                        ...
                        <td class="text-right">
                            <div class="actions ml-3 rtl-actions">
                                ...
                                <a href="#" class="action-item text-danger mr-2 emp_delete delete-icon" data-toggle="tooltip" data-original-title="<?php echo e(__('Delete')); ?>" 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/q5w20afri03w/public_html/hrm/resources/views/zoom_meeting/index.blade.php ENDPATH**/ ?>