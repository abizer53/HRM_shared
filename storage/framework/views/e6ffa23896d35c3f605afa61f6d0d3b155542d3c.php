    ...
    <div class="row">
        <div class="col-md-12 row">
            <div class="card bg-none card-box col-md-8">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php echo e(Form::label('leave_bases', __('Leave Basis On'))); ?> <br />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group single_date_div">
                            <?php echo e(Form::label('single_date', __('Date'))); ?>

                            <?php echo e(Form::text('single_date', null, ['class' => 'form-control datepicker'])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <a href="<?php echo e(route('leave.index')); ?>" class="btn-sm btn-create bg-gray"><?php echo e(__('Cancel')); ?></a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/q5w20afri03w/public_html/hrm/resources/views/leave/create.blade.php ENDPATH**/ ?>