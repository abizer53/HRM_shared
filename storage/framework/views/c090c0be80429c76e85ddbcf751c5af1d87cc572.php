<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Create Leave Type')); ?>
                                ...
                                <div class="tab">
                                    <div class="card " style="width:100%">
                                        ...
                                        <div class="card-body collapse show" id="collapseExample1">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <?php echo e(Form::label('title', __('Leave Type Name'), ['class' => 'form-control-label'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-12 parent">
                                                ...
                                                <div id="date_join_show" style="display: none;" class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" id="specific_date" value="<?php echo e(date('Y-m-d')); ?>">
                                                    </div>
                                                </div>
                        ...
                        <div class="col-md-12" id="previewTab" style="display:none;">
                            ...
                            <p id="preview"></p>
                            <form action="<?php echo e(route('leavetype.store')); ?>" method="post" id="regForm">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/q5w20afri03w/public_html/hrm/resources/views/leavetype/create-leave.blade.php ENDPATH**/ ?>