        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Leave')): ?>
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="all-button-box">
                    ...
                    <a href="<?php echo e(route('leave.create')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($leave->leaveType->measure); ?></td>
                                        ...
                                        <td><?php echo e($leave->start_time ?? '-'); ?></td>
                                        <td><?php echo e($leave->end_time ?? '-'); ?></td>
                                        <?php
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/q5w20afri03w/public_html/hrm/resources/views/leave/index.blade.php ENDPATH**/ ?>